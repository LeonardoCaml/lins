...
const WHATSAPP_LINK = "https://wa.me/5581999999999";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6">
            ...
            <p className="text-primary-foreground/80 text-sm leading-relaxed">
              ...
              e Benefícios do INSS, com atuação em todo o Brasil.
            </p>
            <a
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-lg font-serif text-accent mb-6">Navegação</h4>
          ...
          {/* Services */}
          <div>
            <h4 className="text-lg font-serif text-accent mb-6">Especialidades</h4>
          ...
          {/* Contact */}
          <div>
            <h4 className="text-lg font-serif text-accent mb-6">Contato</h4>
            <ul className="space-y-4">
              ...
              <li>
                ...
                >
                  ...
                  <span className="text-sm">contato@linsadvogados.com.br</span>
                </a>
              </li>
        ...
        <div className="mt-12 pt-8 border-t border-accent/20">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-primary-foreground/60">
              © {new Date().getFullYear()} Lins Advogados. Todos os direitos reservados.
            </p>
