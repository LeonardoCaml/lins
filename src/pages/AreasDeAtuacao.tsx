...
const WHATSAPP_LINK = "https://wa.me/5581999999999?text=Olá! Gostaria de saber mais sobre ";
...
const services = [
  {
    ...
    description: "Análise completa do seu histórico contributivo para identificar a melhor modalidade de aposentadoria. Organizamos sua documentação e acompanhamos todo o processo.",
    items: [
  ...
  },
  {
    ...
    description: "Verificamos se sua aposentadoria ou benefício foi calculado corretamente pelo INSS. Muitos segurados têm direito a valores maiores.",
    items: [
  ...
  },
  {
    ...
    description: "Orientação para afastamento por problemas de saúde, com organização correta da documentação médica e acompanhamento das perícias.",
    items: [
  ...
  },
  {
    ...
    description: "Benefício assistencial para idosos e pessoas com deficiência em situação de vulnerabilidade. Verificamos os requisitos e organizamos seu requerimento.",
    items: [
  ...
  },
  {
    ...
    description: "Acompanhamento completo do processo de pensão por morte, garantindo que os dependentes recebam o benefício a que têm direito.",
    items: [
  ...
  },
  {
    ...
    description: "Atuação em demandas familiares com foco em pensão alimentícia, guarda e questões relacionadas.",
    items: [
      "Ação de alimentos",
  ...
  },
  {
    ...
    description: "Assessoria em questões cíveis diversas, com atendimento personalizado e estratégia adequada para cada caso.",
    items: [
      "Contratos em geral",
  ...
  },
  {
    ...
    description: "Atuação em processos envolvendo a administração pública, concursos e direitos de servidores.",
    items: [
      "Concursos públicos",
            ...
            {services.map((service, index) => (
              ...
              >
                ...
                <div className={index % 2 === 1 ? "lg:order-2" : ""}>
                  <div className="flex items-center gap-3 mb-4">
                    <div className={`w-12 h-12 rounded-lg flex items-center justify-center ${
                      service.highlight ? "bg-primary text-primary-foreground" : "bg-muted text-muted-foreground"
                    }`}>
                  ...
                  <Button variant={service.highlight ? "gold" : "wineOutline"} asChild>
                    <a href={WHATSAPP_LINK + service.title} target="_blank" rel="noopener noreferrer">
                ...
                <div className={`bg-secondary rounded-xl p-8 ${index % 2 === 1 ? "lg:order-1" : ""}`}>
                  <h3 className="font-semibold text-foreground mb-6">O que inclui:</h3>
      ...
      <section className="py-16 section-wine">
        <div className="container mx-auto px-4 text-center">
          ...
          <Button variant="gold" size="lg" asChild>
            <a href={WHATSAPP_LINK + "meu caso"} target="_blank" rel="noopener noreferrer">
